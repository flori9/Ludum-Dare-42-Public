...
var createTowerOfWater = upgrading_option_add(tile_towerofwater_create);
upgrading_option_requirement_add(createTowerOfWater, "magicalvillage", 0, 1);
upgrading_option_requirement_add(createTowerOfWater, "water", 0, 1);
upgrading_make_unique(createTowerOfWater, "towerofwater");
